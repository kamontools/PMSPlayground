  ...
  <div class="sidebar-demo-page">
    ...
    >
      ...
      >
        ...
        <div class="mega-body" :class="{ 'mega-body--single-col': megaLv2 === 'โครงการ' }">
          <div
...
const DATA = [
  ...
  { lv1: 'บัญชีการเงิน', items: [
    ...
    { id: 'ap', label: 'เจ้าหนี้ AP', icon: 'text-ap', lv3: [
      { label: 'จัดซื้อ', lv4: ['ใบขอซื้อ PR', 'ใบสั่งซื้อ PO', 'ใบรับสินค้า/ใบรับวางบิล', 'ใบเสร็จด้านจ่าย'] },
      { label: 'ชำระ', lv4: ['จ่ายชำระ', 'ภาษีหัก ณ ที่จ่าย'] },
      { label: 'รายงานเจ้าหนี้', lv4: ['รายงานเจ้าหนี้', 'รายงาน ภ.ง.ด.'] },
      { label: 'ใบตั้งเบิก', lv4: ['จัดการใบตั้งเบิก', 'รายงานใบตั้งเบิก', 'ตั้งค่าใบตั้งเบิก'] }
    ] },
    { id: 'gl', label: 'บัญชี GL', icon: 'text-gl', lv3: [
      { label: 'รายงานบัญชี' },
      { label: 'เงินสดย่อย', lv4: ['เงินสดย่อย', 'รายงานเงินสดย่อย'] },
      { label: 'บันทึกบัญชี', lv4: ['ใบแจ้งหนี้มาลงบัญชี (ลูกหนี้)', 'ใบเสร็จมาลงบัญชี (ลูกหนี้)', 'บันทึกบัญชี-ทั่วไป', 'ปิดรอบบัญชี'] },
  ...
  { lv1: 'ตั้งค่าโครงการ', items: [
    { id: 'setting-finance', label: 'บัญชีการเงิน', icon: 'gear', lv3: [
      { label: 'ตั้งค่าลูกหนี้ AR', lv4: ['รายรับ', 'ชุดเรียกเก็บ', 'ทะเบียนมิเตอร์', 'รูปแบบการคำนวณมิเตอร์', 'กำหนดอัตราค่าปรับ', 'สต๊อกคีย์การ์ด'] },
      { label: 'ตั้งค่าเจ้าหนี้ AP', lv4: ['ผู้จัดจำหน่าย', 'รายจ่าย'] },
...
.mega-body--single-col { grid-template-columns: 200px; }
.mega-col { padding: 0; }
.mega-col:not(.leaf) {
  border: 1px solid var(--color-dividers, #E4E7ED);
  border-radius: 16px;
